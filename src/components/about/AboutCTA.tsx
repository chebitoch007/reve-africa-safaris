 ...
 * AboutCTA
 *
 * About page closing call to action. Client Component for scroll animation.
 * Surface: bg-deep (basalt-950) — the deepest, most dramatic surface.
 *
 * Mirrors the homepage FinalCTA pattern but with about-specific copy.
...
import { ABOUT_CTA } from '@/lib/constants/about';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at 50% 80%, rgba(212,160,23,0.08) 0%, transparent 60%)' }}
        aria-hidden="true"
      />
