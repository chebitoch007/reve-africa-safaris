 ...
 * GalleryCTA
 *
 * Gallery page closing call to action. Client Component.
...
import { GALLERY_CTA } from '@/lib/constants/gallery';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] w-full mx-auto max-w-[90rem] px-5 sm:px-8 lg:px-16 text-center">
        ...
        >
          <Link
            href={GALLERY_CTA.primaryCTA.href}
            className={cn(
          ...
          >
            {GALLERY_CTA.primaryCTA.label}
          </Link>

          <Link
            href={GALLERY_CTA.secondaryCTA.href}
            className={cn(
              'inline-flex items-center justify-center',
              'px-10 py-4 min-w-[11rem]',
          ...
          >
            {GALLERY_CTA.secondaryCTA.label}
          </Link>
        </motion.div>
