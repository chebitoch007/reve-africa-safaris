 ...
 * FAQSection
 *
 * Accessible accordion FAQ. Client Component — manages open/close state.
 * Each item uses a <button> controlling a region, with aria-expanded and
 * aria-controls for full screen-reader support.
 *
 * Only one item open at a time (single-expand pattern).
 */
